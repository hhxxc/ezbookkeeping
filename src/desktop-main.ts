        ...
        themes: {
            light: {
                ...
                colors: {
                    ...
                    'on-notification-background': '#0d253d',
                    'grey': '#64748d',
                    'grey-50': '#f8fafc',
                    'grey-100': '#e3e8ee',
                    'grey-200': '#c1cdd9',
                    ...
                    'grey-800': '#424242',
                    'grey-900': '#212121',
                    'perfect-scrollbar-thumb': '#c1cdd9',
            ...
            dark: {
                ...
                colors: {
                    ...
                    'surface': '#1c1e54',
                    'on-surface': '#e2e8f0',
                    'notification-background': '#1c1e54',
                    ...
                    'skin-bordered-background': '#1c1e54',
                    'skin-bordered-surface': '#1c1e54',
                    'expansion-panel-text-custom-bg': '#161b3a'
                },
                variables: {
                    'code-color': '#ff8000',
                    'overlay-scrim-background': '#0a0e1a',
                    'tooltip-background': '#0d253d',
