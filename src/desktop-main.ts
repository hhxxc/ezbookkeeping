    ...
    theme: {
        ...
        themes: {
            light: {
                ...
                colors: {
                    'primary': '#8EB69B',
                    'primary-darken-1': '#7AA384',
                    'on-primary': '#ffffff',
                    'secondary': '#6B8F7D',
                    'secondary-darken-1': '#557566',
                    'on-secondary': '#ffffff',
                    'success': '#4cd964',
                    ...
                    'teal': '#235347',
                    'background': '#F5F7F4',
                    'on-background': '#2C3E35',
                    'surface': '#fff',
                    'on-surface': '#2C3E35',
                    'notification-background': '#ffffff',
                    'on-notification-background': '#2C3E35',
                    'grey': '#8c8c8c',
                    'grey-50': '#f2f5f3',
                    'grey-100': '#f0f2f8',
                    'grey-200': '#eeeeee',
                    ...
                    'grey-800': '#424242',
                    'grey-900': '#212121',
                    'perfect-scrollbar-thumb': '#c8d4cc',
                    'skin-bordered-background': '#F5F7F4',
                    'skin-bordered-surface': '#fff',
                    'expansion-panel-text-custom-bg': '#f0f5f2'
                },
                variables: {
                    'code-color': '#ff8000',
                    'overlay-scrim-background': '#1A2E24',
                    'tooltip-background': '#163832',
                    ...
                    'border-color': '#2C3E35',
                    'border-opacity': 0.12,
                    'table-header-color': '#f0f5f2',
                    'high-emphasis-opacity': 0.9,
                    'medium-emphasis-opacity': 0.7,

                    // 👉 shadows
                    'shadow-key-umbra-color': '#1A2E24',
            ...
            dark: {
                ...
                colors: {
                    ...
                    'teal': '#235347',
                    'background': '#051F20',
                    'on-background': '#D4E0D6',
                    'surface': '#0B2B26',
                    'on-surface': '#D4E0D6',
                    'notification-background': '#163832',
                    'on-notification-background': '#D4E0D6',
                    'grey': '#4d4c4b',
                    'grey-50': '#0D2A26',
                    'grey-100': '#163832',
                    'grey-200': '#1F3D38',
                    ...
                    'grey-800': '#d8d8d8',
                    'grey-900': '#eaeaea',
                    'perfect-scrollbar-thumb': '#235347',
                    'skin-bordered-background': '#163832',
                    'skin-bordered-surface': '#163832',
                    'expansion-panel-text-custom-bg': '#1A332E'
                },
                variables: {
                    'code-color': '#ff8000',
                    'overlay-scrim-background': '#051F20',
                    'tooltip-background': '#235347',
                    'tooltip-color': '#D4E0D6',
                    ...
                    'border-color': '#235347',
                    'border-opacity': 0.12,
                    'table-header-color': '#0D2A26',
                    'high-emphasis-opacity': 0.9,
                    'medium-emphasis-opacity': 0.7,

                    // 👉 Shadows
                    'shadow-key-umbra-color': '#051F20',
