...
class DynamicExpirationPlugin implements WorkboxPlugin {
    private static readonly SW_CACHE_TIME_HEADER: string = 'nestkeep-sw-cache-time';
...
const SW_ASSETS_CACHE_NAME: string = 'nestkeep-assets-cache';
const SW_CODE_CACHE_NAME: string = 'nestkeep-code-cache';
const SW_MAP_CACHE_NAME: string = 'nestkeep-map-cache';
const SW_SHARE_CACHE_NAME: string = 'nestkeep-share-cache';
